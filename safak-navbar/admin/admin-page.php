                ...
                <div class="safak-navbar-admin__lang-group">
                    ...
                    <div class="safak-navbar-admin__field-row">
                        ...
                        <div class="safak-navbar-admin__field">
                            ...
                            <input type="url" id="safak_navbar_button_link_ar" name="safak_navbar_button_link_ar" value="<?php echo esc_attr( get_option( 'safak_navbar_button_link_ar', '#' ) ); ?>" class="regular-text" placeholder="https://" />
                        </div>
                    </div>
                </div>
                ...
                <div class="safak-navbar-admin__lang-group">
                    ...
                    <div class="safak-navbar-admin__field-row">
                        ...
                        <div class="safak-navbar-admin__field">
                            ...
                            <input type="url" id="safak_navbar_button_link_fr" name="safak_navbar_button_link_fr" value="<?php echo esc_attr( get_option( 'safak_navbar_button_link_fr', '#' ) ); ?>" class="regular-text" placeholder="https://" />
                        </div>
                    </div>
                </div>
                ...
                <div class="safak-navbar-admin__lang-group">
                    ...
                    <div class="safak-navbar-admin__field-row">
                        ...
                        <div class="safak-navbar-admin__field">
                            ...
                            <input type="url" id="safak_navbar_button_link_en" name="safak_navbar_button_link_en" value="<?php echo esc_attr( get_option( 'safak_navbar_button_link_en', '#' ) ); ?>" class="regular-text" placeholder="https://" />
                        </div>
                    </div>
                </div>
            </div>
